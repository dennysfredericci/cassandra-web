...
RUN cd /go/src/ && git clone https://github.com/dennysfredericci/cassandra-web.git --depth=1
...
RUN cd /go/src/ && git clone https://github.com/dennysfredericci/cassandra-web.git
